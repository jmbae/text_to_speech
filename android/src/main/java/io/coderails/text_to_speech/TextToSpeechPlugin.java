package io.coderails.text_to_speech;
 ...
 * TextToSpeechPlugin
 */
public class TextToSpeechPlugin implements MethodCallHandler {
  ...
  private TextToSpeechPlugin(Context context, MethodChannel channel) {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    channel.setMethodCallHandler(new TextToSpeechPlugin(registrar.activeContext(), channel));
  }
